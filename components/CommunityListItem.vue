...
<script>
    ...
    import MixTypeItem from '@c/MixTypeItem'
    import ImageTypeItem from '@c/ImageTypeItem'
    import VideoTypeItem from '@c/VideoTypeItem'
    ...
    export default {
        ...
        methods : {
            ...
            async setUserInfo() {
                let res = await axios.get(this.$api.user.getUserInfo(this.itemData.user_id))
                if (res.data.state) {
